...
[🌐 Website](https://anoncalm.github.io) | 📧 Welcome to join us by email at XXXX@XXXX
</div>
...
## 📣 News
[XXXX.XX.XX] Causal Evaluation of Language Models (CaLM) is released, including technical report, evaluation dataset and codebase.

## 🤩 Participate by Submitting Your Results!
We invite you to contribute to our project by submitting your model-generated results. Please refer to our [submission guideline](https://anoncalm.github.io/calm_website/pages/submit.html) to ensure your submissions are processed efficiently. Additionally, we welcome contributions such as new models, prompts, datasets, and metrics. Contact us at XXXX@XXXX for more information.

## ⌨️ Quick Start
### installation
```
git clone https://github.com/AnonCaLM/CaLM.git
...
To add your model, please submit a pull request and email us at XXXX@XXXX. For details on adding models to our benchmarks, see [model details](documents/model_details.md).
...
We support the ground truth (GT) labels for public datasets with references, but keep our own dataset's GT labels unreleased for further use. If you want to evaluate your model on the whole dataset, kindly reach out to us by email at XXXX@XXXX. We will reply in 3 days. The `responses.json` files generated by your model will be required. For details, see [submission guideline](https://anoncalm.github.io/calm_website/pages/submit.html).

If you want to add your own dataset, please submit a pull request and email us at XXXX@XXXX.
...
We welcome contributions to add new prompt styles via pull requests. Remember to further inform us at XXXX@XXXX.
...
We welcome contributions of new metrics or error types through pull requests. Please also email us at XXXX@XXXX to submit your pull request.
